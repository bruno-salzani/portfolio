    ...
    <div className="flex flex-col gap-12">
        ...
        {visibleCategories.map(([category, certs]) => (
          <div key={category} className="animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex items-center gap-4 mb-8">
              <h3 className="text-xl font-black text-white uppercase tracking-wider">{getTranslatedCategory(category)}</h3>
      ...
      <div className="flex justify-center mt-8">
        ...
        >
          ...
          {isExpanded ? t('certifications.minimize') : t('certifications.expand')}
        </button>
      </div>
