...
export const EXPERIENCES: Experience[] = [
  {
    ...
    location: {
      en: "Belém, Pará, Brazil · Remote",
      pt: "Belém, Pará, Brasil · Remota"
    },
    description: {
      en: [
        "Mobile Automation Architecture (Project Helios): Led the development of the mobile automation framework using Appium, structuring functional and regression tests to ensure delivery stability on Android and iOS devices.",
        "E2E Test Engineering (Project Uranus): Developed and maintained a robust end-to-end test suite using Cypress with JavaScript and Cucumber (BDD). Implemented design patterns such as Page Objects (POM) to increase code maintainability and reduce test flakiness.",
        "Coverage and Quality Optimization (Artemis & Uranus): Expanded unit test coverage in the Uranus and Artemis projects by more than 70%, drastically reducing the incidence of bugs in production and accelerating the feedback cycle for the development team.",
        "Continuous Integration (CI/CD): Responsible for integrating automated tests into GitLab CI and GitHub Actions pipelines. Configured dynamic reports with Allure Reports to provide real-time visibility on project health to stakeholders.",
        "Quality Process Management: Acted in strategic test planning, defining quality metrics and data-driven KPIs to drive the maturity of the development process (Shift-left testing)."
      ],
      pt: [
  ...
  },
  {
    ...
    period: {
      en: "Jun 2018 - May 2024",
      pt: "jun de 2018 - mai de 2024"
    },
    duration: {
      en: "6 years",
      pt: "6 anos"
    ...
    location: {
      en: "Campinas, São Paulo, Brazil · Hybrid",
      pt: "Campinas, São Paulo, Brasil · Híbrida"
    },
    description: {
      en: [
        "Functional Testing: Developed and executed comprehensive test plans for Web and Mobile applications, applying methodologies such as Requirements-Based Testing and BDD.",
        "Integration Testing: Performed integration tests with tools such as Postman and SoapUI, ensuring seamless interaction between system components.",
        "Test Automation: Created and executed automated tests for Web applications using Cypress and Selenium, with code versioning via Git.",
        "Performance Testing: Conducted performance tests using JMeter and Google Lighthouse, optimizing application stability and efficiency.",
        "Defect Management: Reported and managed defects using Jira and Redmine, ensuring efficient resolution and contributing to continuous improvement of quality processes.",
        "Requirements Analysis: Collaborated with the Product Owner and Requirements Analyst to refine project scopes, ensuring all requirements were understood and correctly implemented, identifying possible bugs and inconsistencies.",
        "Team Leadership: Recruited and trained new Quality team members, delegating tasks and monitoring demand progress to ensure high-quality on-time deliveries."
      ],
      pt: [
