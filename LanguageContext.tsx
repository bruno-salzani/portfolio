...
const translations = {
  en: {
    ...
    'hero.description': 'Hi, I am {name}, software quality specialist with 7+ years of experience in manual testing and web automation. I master tools like {tools} to ensure quality and agility in complex projects.',
    'hero.github': 'GITHUB',
  ...
  pt: {
    ...
    'hero.description': 'Olá, sou {name}, Especialista em qualidade de software com 7+ anos de experiência em testes manuais e automação web. Domino ferramentas como {tools} para garantir qualidade e agilidade em projetos complexos.',
    'hero.github': 'GITHUB',
    'hero.linkedin': 'LINKEDIN',
    'hero.cv': 'CURRÍCULO',
